                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <%-- Sử dụng JSTL fmt để định dạng tiền tệ (VND) --%>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-left-info shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Tổng Số Học Viên</div>
...
<script type="text/javascript">
    // Lấy dữ liệu từ request attribute mà Servlet đã gửi qua và gán vào biến JS
    // Các biến này sẽ được file chart-area-demo.js sử dụng
