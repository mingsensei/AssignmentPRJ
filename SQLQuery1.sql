...
(N'jdoe', N'John', N'Doe', N'jdoe@example.com', N'user', '1234567890', N'hashed_password_1', N'google123'),
(N'ajane', N'Alice', N'Jane', N'ajane@example.com', N'admin', '0987654321', N'hashed_password_2', N'google456'),
(N'bsmith', N'Bob', N'Smith', N'bsmith@example.com', N'editor', '1112223333', N'hashed_password_3', N'google789');
